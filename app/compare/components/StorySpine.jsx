...
export default function StorySpine({ result, currency, initialAmount }) {
  ...
  const getSpineRow = (ticker, isWinner, startCap, priceGr, divB, fxEff, finalVal, color, isA) => {
    ...
    return (
      <div className={`space-y-3 p-5 rounded-2xl border transition-all ${isWinner
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-3 lg:gap-1.5 py-2">
          {/* STEP 1: START */}
          <div className="flex flex-col items-center justify-center p-3 bg-white dark:bg-slate-950 rounded-xl border border-slate-150 dark:border-slate-850/60 w-full lg:flex-1 lg:min-w-0 shadow-sm text-center">
            <span className="text-[8px] text-slate-400 font-mono uppercase font-bold tracking-wider">Start Capital</span>
            <span className="font-mono text-xs sm:text-sm font-extrabold text-slate-800 dark:text-slate-200 mt-1">
          ...
          {!isHome && (
            <>
              ...
              <div className="flex flex-col items-center justify-center p-3 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 w-full lg:flex-1 lg:min-w-0 shadow-inner text-center">
                <span className="text-[8px] text-slate-500 font-mono uppercase font-bold tracking-wider">Initial Exchange</span>
                <span className="font-mono text-xs sm:text-sm font-extrabold text-slate-700 dark:text-slate-300 mt-1">
          ...
          <div className="flex flex-col items-center justify-center min-w-[50px] text-center my-1 lg:my-0">
            <span className="text-[8px] text-blue-600 dark:text-blue-400 font-mono bg-blue-50 dark:bg-blue-950/40 px-2 py-0.5 rounded border border-blue-100/50 dark:border-blue-900/30 font-bold">
          ...
          <div className="flex flex-col items-center justify-center p-3 bg-white dark:bg-slate-950 rounded-xl border border-slate-150 dark:border-slate-850/60 w-full lg:flex-1 lg:min-w-0 shadow-sm text-center">
            ...
            {isHome ? (
              <span className="font-mono text-xs sm:text-sm font-extrabold text-blue-600 dark:text-blue-400 mt-1">
          ...
          <div className="flex flex-col items-center justify-center min-w-[65px] text-center my-1 lg:my-0">
            <span className="text-[8px] text-emerald-600 dark:text-emerald-400 font-mono bg-emerald-50 dark:bg-emerald-950/40 px-2 py-0.5 rounded border border-emerald-100/50 dark:border-emerald-900/30 font-bold">
          ...
          <div className="flex flex-col items-center justify-center p-3 bg-white dark:bg-slate-950 rounded-xl border border-slate-150 dark:border-slate-850/60 w-full lg:flex-1 lg:min-w-0 shadow-sm text-center">
            ...
            {isHome ? (
              <span className="font-mono text-xs sm:text-sm font-extrabold text-emerald-600 dark:text-emerald-400 mt-1">
          ...
          {!isHomeA && isA && (
            <>
              ...
              <div className="flex flex-col items-center justify-center min-w-[65px] text-center my-1 lg:my-0">
                ...
                <span className={`text-[10px] font-extrabold ${fxEff >= 0 ? "text-violet-600 dark:text-violet-400" : "text-rose-600 dark:text-rose-400"} font-mono`}>
          ...
          {((isHomeA && isA) || (isHomeB && !isA)) && (
            <div className="flex flex-col items-center justify-center min-w-[55px] text-center my-1 lg:my-0">
              <span className="text-[7px] text-slate-400 font-mono uppercase font-bold">
                TOTAL
              </span>
              <span className="text-sm font-bold text-slate-300 dark:text-slate-700 mt-0.5 lg:rotate-0 rotate-90">➔</span>
            </div>
          ...
          {/* STEP 5: FINAL WALLET */}
          <div className={`flex flex-col items-center justify-center p-3 rounded-xl border w-full lg:flex-1 lg:min-w-0 shadow-sm text-center ${isWinner
            ...
            <span className="font-mono text-xs sm:text-sm font-black mt-1">
